...
This code was forked from stefanwille/crowd and modified to avoid namespace clashes
with User classes.

== INSTALL:

  Add the following lines to your bundle
  
    gem 'soap4r-spox', :git => 'git://github.com/spox/soap4r-spox.git' # 1.9.2 support
    gem 'crowd-crossroads', :git => 'http://github.com/crossroads/crowd.git'
...
updated by Steve Kenworthy & Sam Scully <enquiries@globalhand.org>
...
Updated by Steve Kenworthy & Sam Scully on 2010-11-17
